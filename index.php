<?php
session_start();
if ( ! empty( $_SESSION['user'] ) && $_SESSION['user_status'] == 'user' ) {
	header( "location: http://" . $_SERVER['HTTP_HOST'] . '/user.php' );
	exit;
} else if ( ! empty( $_SESSION['user'] ) && $_SESSION['user_status'] == 'admin' ) {
...
/*
$stmt = oci_parse($conn, "insert into city (name_city) values ('Kiev')" );
oci_execute($stmt, OCI_COMMIT_ON_SUCCESS);
var_dump('hui');die();*/

//$create->create_city('Kiev');
//die();
?>
				...
				<form class="form_sign_in forms">
					...
					<div class="form_sign_in_content">
						...
						<div class="form_sign_in_links">
							<a href="javascript: void(0)" id="register_now">Register Now</a>
				...
				<form class="form_registration forms">
					...
					<div class="form_registration_content">
						<div class="form_registration_inputs forms_inputs">
							<input  pattern="[0-9]{2}-[0-9]{3}-[0-9]{4}"
									type="tel"
									maxlength="9"
									placeholder="Telephone"
									name="register_name"
									required
							/>
							<input type="text" placeholder="FIO" name="register_fio" required />
							<select name="register_city"> <!--Supplement an id here instead of using 'name'-->
								<?php
