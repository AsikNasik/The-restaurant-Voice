            ...
            <div class="header_head">
                ...
                <div class="header_head_contacts">
                    ...
                    <div class="header_head_authorization">
                        ...
                        <a data-effect="mfp-zoom-out" id="authorization" href="/logout.php">Log out</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form class="form_review forms">
                        ...
                        <div class="form_review_content">
                            <div class="form_review_inputs forms_inputs">
                                <input disabled name="telephone" type="text" maxlength="9" placeholder="Telephone" value="<?php echo $_SESSION['user'] ?>" required />
                                <textarea name="note" rows="6" cols="32" placeholder="Review" maxlength="350" required></textarea>
                                <input name="mark" type="number" value="5" max="5" min="1" step="1" required />
                            </div>
                            <button id="send_review" class="button_style_review button_style_form">
                                Send
                            </button>
                        </div>
                    </form>
                    ...
                    <div class="footer_content_main_location">
                        ...
                        <ul>
                            ...
                            <li class="email_restaurant">
                                <a href="https://mail.google.com/mail">voice_restaurant@gmail.com</a>
                            </li>
                            <li>+38 (066)-93-45-556</li>
                            <li>+38 (093)-45-93-556</li>
                        </ul>
...
<!-- SVG follow us -->
<svg class="root-svg-symbols-element" xmlns="http://www.w3.org/2000/svg" style="
      border: 0 !important;
