...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,400;0,700;1,100;1,700&display=swap"
        rel="stylesheet"
    />
        ...
        <div class="header_head">
            ...
            <div class="header_head_contacts">
                ...
                <div class="header_head_authorization">
                    <a data-effect="mfp-zoom-out" id="authorization">Authorization</a>
                    <a data-effect="mfp-zoom-out" id="registration">Registration</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="section_dish_day_item_content">
                        <div class="section_dish_day_item_info">
                            ...
                            <div class="section_dish_day_item_info_text">
                                ...
                                Tenetur eligendi repudiandae impedit inventore sunt nisi quod,
                                assumenda ea delectus soluta vitae id animi sequi quaerat,
                                quidem laborum molestias laudantium exercitationem?
                            </div>
        ...
        <div class="section_reviews_item">
            <div class="section_reviews_item_content">
                ...
                <div class="section_reviews_item_content_text">
                    ...
                    fuga vitae laborum quidem voluptate iusto obcaecati vero
                    voluptatibus minus aut unde debitis, maxime non dolor quam
                    asperiores libero ea dolorem.
                </div>

                <div class="section_reviews_item_content_person">
                    <img src="./img/bg_header.png" />
                    <p class="auther_name">John Medison</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- FORMS start -->
<section class="section_sign_in section_form">
    <div class="popup_overlay">
        <div class="pop_up_container">
            <div class="section_sign_in_info sections_info">
                <form class="form_sign_in forms">
                    <div class="cross"></div>
                    <div class="form_sign_in_content">
                        <h2>Authorization</h2>
                        <div class="form_sign_in_inputs forms_inputs">
                            <input
                                    name="auto_tel"
                                type="text"
                                maxlength="9"
                                ...
                                required
                            />
                            <input name="auto_pass" type="password" placeholder="Password" required />
                        </div>
                        <button
                            id="sign_in"
                            class="button_style_sign_in button_style_form"
                        >
                            Sign in
                        </button>
                        <div class="horisont_line"></div>
                        <div class="form_sign_in_links">
                            <a href="index.html" id="register_now">Register Now</a>
                            <a href="index.html" id="forgot_password">Forgot Password?</a>
                        </div>
                    </div>
                </form>
            </div>
...
<section class="section_registration section_form">
    <div class="popup_overlay">
        <div class="pop_up_container">
            <div class="section_registration_info sections_info">
                <form class="form_registration forms">
                    <div class="cross"></div>
                    <h2>Registration</h2>
                    <div class="form_registration_content">
                        <div class="form_registration_inputs forms_inputs">
                            <input
                                name="register_name"
                                type="text"
                                maxlength="9"
                            ...
                            />
                            <input 
                            name="register_fio" type="text" placeholder="FIO" required />
                            <input name="register_city" type="text" placeholder="City" list="" required />
                            <input name="register_pass" type="password" placeholder="Password" required />
                            <input name="register_pass2" type="password" placeholder="Password" required />
                        </div>
                        <button
                            id="registration"
                            class="button_style_registration button_style_form"
                        >
                            Register
                        </button>
                    </div>
            ...
            <div class="section_review_info sections_info">
                <form class="form_review forms">
                    ...
                    <div class="form_review_content">
                        ...
                        <button id="review" class="button_style_review button_style_form">
                            Send
                        </button>
                    </div>
                </form>
                ...
                <form class="form_staff forms">
                    ...
                    <div class="form_staff_content">
                        <div class="form_staff_inputs forms_inputs">
                            ...
                            <input type="text" placeholder="Worker type" list="" required />
